      ...
      <main class="main-content">
        ...
        <section v-else class="instructor-section">
          <div class="section-head">
            ...
            <span class="section-subtitle">등록한 상품과 상품별 구독자 수를 확인할 수 있습니다.</span>
          </div>
          ...
          <div class="summary-cards">
            ...
            <div class="summary-card">
              <div class="summary-label">총 구독자 수</div>
            ...
            >
              ...
              <div class="course-meta-grid">
                <div class="meta-box">
                  ...
                  <div class="meta-value">{{ formatCategory(course.category) }}</div>
                </div>
                <div class="meta-box">
                  <div class="meta-label">구독 가격</div>
                  <div class="meta-value">{{ formatPrice(course.price) }}</div>
                </div>
                <div class="meta-box">
                  <div class="meta-label">구독자 수</div>
...
async function loadStudentRecommendations() {
  try {
    if (!auth.user) {
      ...
      recommendError.value = '추천 상품을 준비 중입니다.'
      return
    }
    ...
    recommendError.value = '현재 추천 상품을 불러오지 못했습니다. 잠시 후 다시 시도해 주세요.'
  } finally {
...
async function loadInstructorCourses() {
  try {
    if (!auth.user) {
      ...
      instructorError.value = '상품 정보를 불러오지 못했습니다.'
      return
    }
    ...
    instructorError.value = '현재 상품 정보를 불러오지 못했습니다. 잠시 후 다시 시도해 주세요.'
  } finally {
