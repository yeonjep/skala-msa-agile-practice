  ...
  <div class="login-page">
    <div class="login-layout">
      ...
      <div class="login-left">
        <div class="brand">
          <img src="@/assets/images/logo/main_logo.png" alt="한끼픽" class="brand-logo" />
          <span class="brand-name">한끼픽</span>
        </div>
        <div class="brand-content">
          <h2>오늘의 식탁을<br>골라보세요</h2>
          <p>로그인하고 나만의 식품 구독을 시작해 보세요.</p>
      ...
      <div class="login-right">
        <div class="login-box fade-in-up">
          ...
          <div v-if="!showRegister" class="section">
            ...
            <p class="section-desc">한끼픽 계정으로 로그인합니다.</p>
            ...
            <form @submit.prevent="handleRegister" class="form">
              ...
              <div class="form-group">
                ...
                <select v-model="registerForm.role" class="form-input">
                  <option value="STUDENT">구독자</option>
                  <option value="INSTRUCTOR">공급사</option>
                </select>
              </div>
...
const features = ['내 구독 상품 확인', '맞춤 식품 추천', '간편한 구독 관리']
...
.login-left {
  background: linear-gradient(160deg, #1E5A24 0%, #2F7D32 50%, #5AAE61 100%);
  padding: 48px;
  display: flex;
