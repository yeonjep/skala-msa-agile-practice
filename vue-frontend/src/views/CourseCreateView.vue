    ...
    <div class="page-layout">
      ...
      <aside class="sidebar">
        <div class="sidebar-section">
          ...
          >
            <span class="si-icon">✍️</span> 상품 등록
          </router-link>
      ...
      <main class="main-content">
        <div class="content-header">
          <div>
            ...
            <p class="page-subtitle">공급사 계정으로 새로운 상품을 등록합니다.</p>
          </div>
        </div>
          ...
          <form class="course-form" @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
              ...
              <textarea
                ...
                class="form-textarea"
                rows="6"
                placeholder="상품 구성과 배송 안내를 입력해 주세요."
              ></textarea>
            </div>

            <div class="form-row">
              <div class="form-group">
                <label class="form-label" for="category">식품 카테고리</label>
                <select id="category" v-model="form.category" class="form-select">
                  <option disabled value="">식품 카테고리를 선택하세요</option>
                  <option
              ...
              <div class="form-group">
                <label class="form-label" for="price">구독 가격</label>
                <input
                  id="price"
...
function validateForm() {
  ...
  if (!auth.user || auth.user.role !== 'INSTRUCTOR') {
    validationError.value = '공급사 계정만 상품을 등록할 수 있습니다.'
    return false
  }
  ...
  if (!form.category) {
    validationError.value = '식품 카테고리를 선택해 주세요.'
    return false
  }

  if (form.price === null || form.price === undefined || form.price === '') {
    validationError.value = '구독 가격을 입력해 주세요.'
    return false
  }

  const price = Number(form.price)
  if (Number.isNaN(price) || price < 0) {
    validationError.value = '구독 가격은 0 이상의 숫자로 입력해 주세요.'
    return false
  }
